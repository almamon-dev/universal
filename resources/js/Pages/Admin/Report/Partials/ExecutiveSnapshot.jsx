    ...
    return (
        <Card className={cn("flex-1 shadow-none border rounded-md overflow-hidden transition-all", config.border, config.bg)}>
            <CardContent className="p-4 space-y-1">
                <p className={cn("text-[10px] font-bold tracking-tight", config.text)}>{label}</p>
...
export default function ExecutiveSnapshot({ stats }) {
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="space-y-2">
                <p className="text-[10px] font-bold text-slate-400 tracking-tight">Conversation classification</p>
            ...
            <div className="space-y-2">
                <p className="text-[10px] font-bold text-slate-400 tracking-tight">Sellable conversation flow</p>
